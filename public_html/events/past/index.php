...
<p style="float: right; font-size: 14px;"><a href="../">View Upcoming Events</a></p>
...
foreach($events as $event ){
	...
	echo "<p>Location: ".$event->location ."<br>Date: " .$event['date'] . " at " . $event['startTime'] . "<br>" . $event->type;
